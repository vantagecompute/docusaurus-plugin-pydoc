 ...
 * @param {string} [options.label='SDK Reference'] Title of the generated index page, and
 *   therefore the sidebar label of the category Docusaurus builds from `outputDir`. Set it
 *   whenever a site runs more than one instance of this plugin, or every instance's
 *   category is labelled `SDK Reference`.
 * @param {number} [options.position] `sidebar_position` for that category. Absent, an
 *   autogenerated sidebar orders the categories alphabetically by directory name.
